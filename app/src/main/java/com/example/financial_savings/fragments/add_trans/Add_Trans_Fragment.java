...
public class Add_Trans_Fragment extends Fragment implements IMappingView {
    ...
    private void loadTransactionSpeed() {
        if(getArguments() != null) {
            String idTrans = getArguments().getString("idTrans");
            Toast.makeText(getActivity(), idTrans, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void init() {
        ...
        editTextRemind = root.findViewById(R.id.editTextRemind_transaction_add);
        checkBoxRepeat = root.findViewById(R.id.checkBoxRepeat_transaction_add);
        checkBoxFast = root.findViewById(R.id.checkBoxFast_transaction_add);
        buttonHelpRepeat = root.findViewById(R.id.buttonHelpRepeat_transaction_add);
        buttonHelpFast = root.findViewById(R.id.buttonHelpFast_transaction_add);
        textViewRepeat = root.findViewById(R.id.textViewRepeat_transaction_add);
...
//        Bundle bundle = Add_Trans_Fragment.this.getArguments();
//        String str = bundle.getString("idTrans");
